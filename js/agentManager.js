...
function AgentManager(gameManager) {
    //console.log("agentmanager touch");
...
AgentManager.prototype.selectMove = function () {
    ...
    if (this.gameManager.over) {
        ...
        if (this.gameManager.won && !this.gameManager.keepPlaying) {
            ...
            let selectedmove = this.agent.selectMove(this.gameManager); 
            if (!this.gameManager.move(this.agent.selectMove(this.gameManager))) {
                console.log("bad move! - selected " + selectedmove);
               // console.log("Game state after attempted move:", this.gameManager.grid.serialize());
            }
            else this.moveCount++;
